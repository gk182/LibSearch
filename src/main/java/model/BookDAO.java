...
public class BookDAO {
	...
	public boolean updateBook(String title, String author, String category, int quantity, double price, String description, String publisher, int publishYear, String imageLink, String id, String updatedBy) throws SQLException {
	    try (Connection conn = DBConnection.getConnection()) {
	        // Cập nhật thông tin sách trong bảng books
	        String updateQuery = "UPDATE books SET title = ?, author = ?, category = ?, quantity = ?, price = ?, description = ?, publisher = ?, publish_year = ?, image_link = ? WHERE id = ?";
	                ...
	                try (PreparedStatement selectStmt = conn.prepareStatement(selectQuery)) {
	                    ...
	                    try (ResultSet rs = selectStmt.executeQuery()) {
	                        if (rs.next()) {
	                            ...
	                            recordHistory(conn, id, "image_link", oldImageLink, imageLink, updatedBy);
	                        }
	                    }
	                }
